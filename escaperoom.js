...
var objects = [
    new RoomObject("ClosetA", "Closet Is Open", ['Shirt', 'EmptyBox',], [], ['Open']),
    new RoomObject("BookBag","A NorthFace BookBag",["DrawerKey"], [], ["Open"]),
    new RoomObject("Drawer", "Drawer Is Locked You Need The Keys To Open It", ["Bullets", "Flashlight"], ['DrawerKey'], ["Open"]),
    new RoomObject("Bed", "The bed looks Comfy",["ClosetKey"], [], "lift"),
    new RoomObject('Guitar', 'Fragile Acoustic Guitar Hmm Seems Like there is something inside' , ["DoorKey"], ["Axe"], ["Inspect", "Smash"]),
    new RoomObject('ClosetB', "It's locked!", ["Axe"], ["ClosetKey"], ["Open", "Inspect"]),
    new RoomObject('Deadbody', 'A foul stench. Looks like the person has been dead for a while', ['Gun'], [], ["Inspect"]),
    new RoomObject('Door', 'The Door Is Locked You Need A Key', [], ["DoorKey"], ["Open"])
]
